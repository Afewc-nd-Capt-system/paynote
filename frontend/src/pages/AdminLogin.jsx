...
function AdminLogin({ onLogin }) {
  ...
  return (
    <div style={{
      ...
      background: 'radial-gradient(circle at top, rgba(239,68,68,0.18), transparent 28%), radial-gradient(circle at bottom, rgba(249,115,22,0.16), transparent 26%), #f4f5f8'
    }}>
      <div style={{
